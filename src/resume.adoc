...
Conception-Développement-Architecture-QA-Industrialisation-Releasing-Intégration-Dashboarding
...
=== Outils
IntelliJ, Git, Maven3, Jenkins, Gitlab, Slack, Jira, Sonar, NodeJs

=== OPS
Docker, Kubernetes, Vagrant, Ansible, Dashing, Kibana, Grafana
